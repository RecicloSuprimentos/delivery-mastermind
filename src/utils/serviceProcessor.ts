...
async function generateUniqueServiceId(supabaseClient: SupabaseClient, baseServiceId: string): Promise<string> {
...
export async function processService(service: ServiceData, supabaseClient: SupabaseClient): Promise<ProcessedService> {
